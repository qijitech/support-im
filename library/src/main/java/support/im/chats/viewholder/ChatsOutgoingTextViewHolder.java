...
public class ChatsOutgoingTextViewHolder extends ChatsOutgoingViewHolder {

  protected TextView mMessageTextView;

  public ChatsOutgoingTextViewHolder(Context context, ViewGroup parent) {
    super(context, parent, R.layout.chats_outgoing_item_text);
