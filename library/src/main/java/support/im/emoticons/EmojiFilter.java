...
public class EmojiFilter extends EmoticonFilter {
  ...
  @Override public void filter(EditText editText, CharSequence text, int start, int lengthBefore,
      int lengthAfter) {
    ...
    if (m != null) {
      while (m.find()) {
        ...
        EmojiDisplay.emojiDisplay(editText.getContext(), editText.getText(), emojiHex, emojiSize,
