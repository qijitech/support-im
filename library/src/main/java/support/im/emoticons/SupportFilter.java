...
import support.im.emoticons.SupportEmoticons;

public class SupportFilter extends EmoticonFilter {
  ...
  public void filter(EditText editText, CharSequence text, int start, int lengthBefore, int lengthAfter) {
    ...
    if (m != null) {
      while (m.find()) {
        String key = m.group();
        String icon = SupportEmoticons.sXhsEmoticonHashMap.get(key);
  ...
  public static Spannable spannableFilter(Context context, Spannable spannable, CharSequence text,
      int fontSize, EmojiDisplayListener emojiDisplayListener) {
